...
letterN_1.debug=true;

letterS_1.setCollider("rectangle",0,0,100,letterS_1.height)
letterS_1.debug=true;

obstacle_1.setCollider("rectangle",0,0,100,obstacle_1.height)
obstacle_1.debug=true;

obstacle_2.setCollider("rectangle",0,0,100,obstacle_2.height)
obstacle_2.debug=true;

obstacle_3.setCollider("rectangle",0,0,100,obstacle_3.height)
obstacle_3.debug=true;

obstacle_4.setCollider("rectangle",0,0,100,obstacle_4.height)
obstacle_4.debug=true;

obstacle_5.setCollider("rectangle",0,0,100,obstacle_5.height)
obstacle_5.debug=true;

obstacle_6.setCollider("rectangle",0,0,100,obstacle_6.height)
obstacle_6.debug=true;

obstacle_7.setCollider("rectangle",0,0,100,obstacle_7.height)
obstacle_7.debug=true;

obstacle_8.setCollider("rectangle",0,0,100,obstacle_8.height)
obstacle_8.debug=true;

obstacle_9.setCollider("rectangle",0,0,100,obstacle_3.height)
obstacle_9.debug=true;

obstacle_10.setCollider("rectangle",0,0,100,obstacle_10.height)
obstacle_10.debug=true;

obstacle_11.setCollider("rectangle",0,0,100,obstacle_11.height)
obstacle_11.debug=true;

obstacle_12.setCollider("rectangle",0,0,100,obstacle_12.height)
obstacle_12.debug=true;

obstacle_13.setCollider("rectangle",0,0,100,obstacle_13.height)
obstacle_13.debug=true;

obstacle_14.setCollider("rectangle",0,0,100,obstacle_14.height)
obstacle_14.debug=true;

obstacle_15.setCollider("rectangle",0,0,100,obstacle_15.height)
obstacle_15.debug=true;

obstacle_16.setCollider("rectangle",0,0,100,obstacle_16.height)
obstacle_16.debug=true;

obstacle_17.setCollider("rectangle",0,0,100,obstacle_17.height)
obstacle_17.debug=true;

obstacle_18.setCollider("rectangle",0,0,100,obstacle_18.height)
obstacle_18.debug=true;

obstacle_19.setCollider("rectangle",0,0,100,obstacle_19.height)
obstacle_19.debug=true;

obstacle_20.setCollider("rectangle",0,0,100,obstacle_20.height)
obstacle_20.debug=true;

obstacle_21.setCollider("rectangle",0,0,100,obstacle_21.height)
obstacle_21.debug=true;

obstacle_22.setCollider("rectangle",0,0,100,obstacle_22.height)
obstacle_22.debug=true;

obstacle_23.setCollider("rectangle",0,0,100,obstacle_23.height)
obstacle_23.debug=true;

obstacle_24.setCollider("rectangle",0,0,100,obstacle_24.height)
obstacle_24.debug=true;

obstacle_25.setCollider("rectangle",0,0,100,obstacle_25.height)
obstacle_25.debug=true;
